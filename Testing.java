...
public class Testing {
    ...
    public void testSynchronize() throws InterruptedException{
        repo1.commit("Repo 1- Commit 1");
        Thread.sleep(1);
        repo1.commit("Repo 1- Commit 2");
    ...
    public void testSynchronizeMiddle() throws InterruptedException{
        repo1.commit("Repo 1 - Commit 1");
        Thread.sleep(1);
        repo1.commit("Repo1 - Commit 3");
        repo2.commit("Repo2 - Commit 2 (Middle)");
        Thread.sleep(1);
        repo2.commit("Repo2 - Commit 4");
        repo1.synchronize(repo2);
    }
